...
| `.png` | *"Extreme close-up horror jumpscare: a fleshless skull with strips of dried grey skin still attached, jaw hanging open, empty sockets, harsh single-source underlighting, black background."* — `flash_scare` payload |
